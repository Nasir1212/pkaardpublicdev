...
<script>
    ...
    function onClick(){
        ...
        state['product_id'] =  session_data.product_id;
 ...
 async  function get_user_comment(){
        ...
        console.log(server_data)
        const response = await fetch(`/insert_reviews_reating`,{
            method:'POST',
        ...
        if(response.status == 200){
            if(result['condition'] ==true){
                ...
                location.href = `${location.origin}/product_details_view/${session_data.product_id}`;
